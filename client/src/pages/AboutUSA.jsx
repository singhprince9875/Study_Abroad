    ...
    <div className="font-sans bg-gray-100 text-gray-800">
      ...
      <div className="relative">
        <img
          ...
          src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Pano_Manhattan2007_amk.jpg/330px-Pano_Manhattan2007_amk.jpg"
      ...
      <section className="py-12 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl font-semibold mb-6">About USA</h2>
          <p className="text-lg leading-relaxed mb-6">
            ...
            cultural experiences, discover what makes the USA a prime
            ...
            be your guide to unlocking the endless opportunities that the USA
      ...
      <section className="bg-white py-12 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl font-semibold mb-6">Why Study in USA?</h2>
          <p className="text-lg leading-relaxed mb-6">
            Studying in the USA offers unparalleled opportunities for academic
            excellence, cultural enrichment, and personal growth. Renowned for
            its top-ranked universities, innovative research facilities, and
            diverse communities, the USA provides a dynamic learning
            environment. With access to cutting-edge technology, world-class
            faculty, and a vast array of academic programs, students can pursue
            their passions and expand their horizons. Additionally, the USA
            reputation for innovation and entrepreneurship opens doors to
            exciting career prospects. Beyond academics, the country rich
            cultural tapestry, vibrant cities, and scenic landscapes offer
            unforgettable experiences. Discover why studying in the USA is the
      ...
      <section className="py-12 px-6">
        <div className="container mx-auto">
          <h2 className="text-2xl font-semibold text-center mb-6">
            Applying to USA Universities for MS/PhD Programs
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <img
                ...
                src="https://suvidhaoverseas.org/assets/images/AboutUSA.jpg"
                alt="Study in USA"
              />
            </div>
          </div>
      ...
      <section className="bg-gray-200 py-12 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed mb-6">
            Explore the prestigious universities in the USA that offer
