    ...
    <div className="font-sans bg-gray-100 text-gray-800">
      ...
      <div className="relative">
        <img
          ...
          src="https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcR8d_i2FgWjZQ97xkzbo2FtU3MlLhzDEgAb4dFmTCrsLe5hcSthhF-m58rd8RrzR_RCrMW5RUtxfKLOt7VvVMZ_cduQn3AnUDA3IqtSsw"
          alt="About USA Banner"
        />
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <h1 className="text-3xl font-bold text-white text-center px-4">
            Your Canada Dream Starts Here
          </h1>
        </div>
      </div>
      ...
      <section className="py-12 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl font-semibold mb-6">About Canada</h2>
          <p className="text-lg leading-relaxed mb-6">
            Welcome to our About Canada page. Here, we provide essential
            insights into studying in the United States. From top universities
            to cultural experiences, discover what makes the Canada a prime
            ...
            be your guide to unlocking the endless opportunities that the Canada
            has to offer. Your American dream starts here.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-12 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl font-semibold mb-6">Why Study in Canada?</h2>
          <p className="text-lg leading-relaxed mb-6">
            Studying in the Canada offers unparalleled opportunities for
            academic excellence, cultural enrichment, and personal growth.
            Renowned for its top-ranked universities, innovative research
            facilities, and diverse communities, the Canada provides a dynamic
            learning environment. With access to cutting-edge technology,
            world-class faculty, and a vast array of academic programs, students
            can pursue their passions and expand their horizons. Additionally,
            the Canada reputation for innovation and entrepreneurship opens
            doors to exciting career prospects. Beyond academics, the country
            rich cultural tapestry, vibrant cities, and scenic landscapes offer
            unforgettable experiences. Discover why studying in the Canada is
      ...
      <section className="py-12 px-6">
        <div className="container mx-auto">
          <h2 className="text-2xl font-semibold text-center mb-6">
            Applying to Canada Universities for MS/PhD Programs
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <ol className="list-decimal pl-6">
                ...
                <li className="mb-4">
                  ...
                  <p>
                    ...
                    transition to studying in the Canada.
                  </p>
                </li>
              </ol>
            </div>
            <div>
              <img
                ...
                src="https://suvidhaoverseas.org/assets/images/AboutCanada.jpg"
                alt="Study in USA"
              />
            </div>
          </div>
      ...
      <section className="bg-gray-200 py-12 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed mb-6">
            Explore the prestigious universities in the Canada that offer
